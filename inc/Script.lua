...
local msgs = redis:get(max..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
if rfih == 0 then  return "↫عذرا لا يوجد رسائل لك في البوت  ❗️" end
...
usertext = '\n★| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'abazaa')..')'
...
usertext = '\n★|العضو » ['..result.title_..'](t.me/'..(username or 'abazaa')..')'
status  = '\n★| تم رفعه مشرف '
...
return "-حسننا الان ارسل كلمة الرد العام ໑\n"
end
...
▿↜ قــنــاة الـسـورس⇦ [ســورس كلــاو 🕸.](t.me/xclawx)
 🕸
]]
end
...
sendMsg(msg.chat_id_,msg.id_,"-عذراً يا عزيزي لا يمكنك ارسال { توجيه‌‏ , مـلصق , فديو } ❗️")
return false
end
...
redis:del(max..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•໑تم اضافه صوره للرد بنجاح ↯\n•໑يمكنك ارسال ❴ ['..klma..'] ❵ لاظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(max..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(max..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•໑تم اضافه بصمه صوت للرد بنجاح ↯\n•໑يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(max..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(max..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•໑تم اضافه متحركه للرد بنجاح ↯\n•໑يمكنك ارسال ❴ ['..klma..'] ❵ لاظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(max..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(max..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•໑تم اضافه فيديو للرد بنجاح ↯\n•໑يمكنك ارسال ❴ ['..klma..'] ❵ لاظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(max..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(max..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•໑تم اضافه للصوت للرد بنجاح ↯\n•໑يمكنك ارسال ❴ ['..klma..'] ❵ لاظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(max..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(max..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•໑تم اضافه ملصق للرد بنجاح ↯\n•໑يمكنك ارسال ❴ ['..klma..'] ❵ لاظهار الملصق الاتي ')
end  
...
redis:del(max..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•໑تم اضافه صوره للرد العام ↯\n•໑يمكنك ارسال ❴ ['..klma..'] ❵ لاظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(max..'replay_voice:group:',klma,voice_id)
redis:del(max..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•໑تم اضافه بصمه صوت للرد العام ↯\n•໑يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(max..'replay_animation:group:',klma,animation_id)
redis:del(max..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•໑تم اضافه متحركه للرد العام ↯\n•໑يمكنك ارسال ❴ ['..klma..'] ❵ لاظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(max..'replay_video:group:',klma,video_id)
redis:del(max..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•໑تم اضافه فيديو للرد العام ↯\n•໑يمكنك ارسال ❴ ['..klma..'] ❵لاظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(max..'replay_audio:group:',klma,audio_id)
redis:del(max..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•໑تم اضافه للصوت للرد العام ↯\n•໑يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(max..'replay_sticker:group:',klma,sticker_id)
redis:del(max..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•໑تم اضافه ملصق للرد العام ↯\n•໑يمكنك ارسال ❴ ['..klma..'] ❵ لاظهار الملصق الاتي ')
end  
...
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"-تم تغير اسم البوت ໑\n-الان اسمه "..Flter_Markdown(msg.text).." \n↯")
return false
end
...
return sendMsg(msg.chat_id_,msg.id_,'↫تم اذاعه التوجيه بنجاح ໑\n↫للمـجمـوعآت » ❴ *'..#groups..'* ❵\n↫للخآص » ❴ '..#pv..' ❵\n↯')     
end
...
return sendMsg(msg.chat_id_,msg.id_,"•໑جيد , يمكنك الان ارسال جواب الرد \n•໑[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n↯")
end
end
