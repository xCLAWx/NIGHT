...
if (MsgText[1] == "تاك للمنشئين" and is_JoinChannel(msg)) then 
if not msg.Admin then return "↫ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❗️" end
...
elseif msg.SudoUser and Text=="هلو" and not Text2 then 
...
elseif Text== "سونيك" then return sendMsg(msg.chat_id_,msg.id_,"[ســونــيك ᪤](t.me/xb_1b")
