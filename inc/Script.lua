...
else msg.1153357069 then
else msg.656329268 then
...
if MsgText[1] == "الغاء العام" or MsgText[3] == "الغاء عام" thenthen
if not msg.SudoBase then return"↫هذا الامر يخص {المطور الاساسي} فقط  \n✇" end
...
send_key(msg.sender_user_id_,'  [-قناة ســورس نــايت](https://t.me/abazaa)',nil,inline,msg.id_)
return false
end
...
if not redis:get(max..'lave_me'..msg.chat_id_) then
if msg.Admin then return "↫هطردك ازاي وانت رتبه .  \n" end
kick_user(msg.sender_user_id_,msg.chat_id_,function(arg,data)
if data.ID == "Ok" then
StatusLeft(msg.chat_id_,msg.sender_user_id_)
send_msg(msg.sender_user_id_,"-اهلا يا ذليل لقد حظرتك من المجموعه على طلبك \n-اذا كان هذا بالخطأ او اردت الرجوع للمجموعه \n\n-فهذا رابط المجموعه \n 🎴│"..Flter_Markdown(redis:get(max..'group:name'..msg.chat_id_)).." :\n\n["..redis:get(max..'linkGroup'..msg.chat_id_).."]\n")
...
return [[
 .↜ مــطــور الــســورس: [بــاســل](t.me/xb_0b)

.↜ مــــطــــور الــــســــورس : [ســونــيك](t.me/Soonicxx)

.↜ قــنــاة الــســورس[ســورس نــايت .](t.me/abazaa)
 🎴
]]
end
...
local colors = {'blue','green','yellow','magenta','Oxclawxe','DarkOabazaae','red'}
...
elseif Text== "مطور السورس"  then return sendMsg(msg.chat_id_,msg.id_,"[باسـل](t.me/xb_1b") ")
