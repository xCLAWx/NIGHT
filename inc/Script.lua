...
return [[
• 𝙳𝙴𝚅  [sᴏɴɪᴄ](http://t.me/soonicxx)                                                                                                               
• 𝙳𝙴𝚅  [вaѕel](http://t.me/XB_0B)
• sᴏᴜʀᴄᴇ  [ᴄʟᴀᴡ sᴏᴜʀᴄᴇ 💎](t.me/XCLAWX)
]]
end
...
local su = {
  "تحت امرك حبيبي المطور ",
  "اؤمرني يا مطوري ",
  "مطوري الحلو "}
  local ss97 = {
  "اي يقلبي .","عييون البوت ، وقلبـه .",
  "اؤمرني يقلبي .",
  }
  local bs = {
  "كرونا يا",
  "اآآآم͠ــ.❤️😍ــو͠و͠و͠آ͠آ͠ح͠❤️عسسـل❤️",
  "لازم احط كيسه علي وشك 😐✋",
  "اموااه ف شفايفك😍😍💋",
  "مش ببوس حد يقليل الادب 😁",
  "لا اخاف ابقا مريض منك 😷",
  "تؤ مش قدام الناس 😢",
  "استغفر الله يا فاسق 😒",
  }
  local ns = {
  ...
  elseif Text== "☹️"  then return sendMsg(msg.chat_id_,msg.id_,"مين مزعل قلبي")
  ...
  elseif Text== "خرا"  then return sendMsg(msg.chat_id_,msg.id_,"انت مقرف لي؟.")
  ...
  elseif Text== "اسمك اي"  then return sendMsg(msg.chat_id_,msg.id_,"ومش باين اسمي يعني ؟")
  ...
  elseif Text== "حبيبي" or Text=="حبي" then return  sendMsg(msg.chat_id_,msg.id_,"اي ينن عيني")
  elseif Text== "حبيبتي" then return sendMsg(msg.chat_id_,msg.id_,"ع الخاص مش قدام الناي ")
  elseif Text== "حياتي" then return sendMsg(msg.chat_id_,msg.id_,"احب حيـاتك")
  elseif Text== "عمري" then return sendMsg(msg.chat_id_,msg.id_,"يخليلك عمرك")
  ...
  elseif Text== "موجود" then return sendMsg(msg.chat_id_,msg.id_,"اه يقلبي")
  elseif Text== "اكلك" then return sendMsg(msg.chat_id_,msg.id_,"طب اغسل ايدك")
  ...
  elseif Text== "وين"  then return sendMsg(msg.chat_id_,msg.id_,"علي قلبك")
  ...
  elseif Text== "فين قلبي"  then return sendMsg(msg.chat_id_,msg.id_,"اهو بدأنا نتمحون")
  elseif Text== "اسمك اي"  then return sendMsg(msg.chat_id_,msg.id_,"مش شايف ؟")
  elseif Text== "انا"  then return sendMsg(msg.chat_id_,msg.id_,"اعوذ بالله من كلمه انا")
  elseif Text== "نورت"  then return sendMsg(msg.chat_id_,msg.id_,"بنورك")
  elseif Text== "نورتي"  then return sendMsg(msg.chat_id_,msg.id_,"النـور نورك")
  elseif Text== "منورين."  then return sendMsg(msg.chat_id_,msg.id_,"لا دا نورك انت يقمر")
