...
─────▀██▀─────
┊ＭᎯẊ ‿ @Soonicxx
تم تطوير وبرمجة السورس من قبل مطورين سورس كلاو
┊@Soonicxx ‿ @xb_0b
#-------------------------------------------------------------------
]]
...
─────▀██▀─────
┊ＭᎯẊ ‿ @Soonicxx
تم تطوير وبرمجة السورس من مطورين سورس كلاو
┊@Soonicxx ‿ @xb_0b
-------------------------------------------------------------------
]]..'\027[0;32m')
create_config() 
...
msg.Rank = 1
elseif msg.sender_user_id_ == 656329268 then 
msg.TheRank =  ' مطور السورس '
msg.Rank = 1
